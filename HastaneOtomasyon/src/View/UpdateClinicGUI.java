...
public class UpdateClinicGUI extends JFrame {
	...
	public UpdateClinicGUI(Clinic clinic) {
		...
		lblNewLabel_1_2.setBounds(10, 11, 155, 25);
		contentPane.add(lblNewLabel_1_2);
		
		fld_clinicName = new JTextField();
		fld_clinicName.setFont(new Font("Yu Gothic UI Light", Font.PLAIN,13));
		fld_clinicName.setColumns(10);
		fld_clinicName.setBounds(10, 34, 191, 25);
		...
		btn_updateClinic.setBounds(10, 61, 191, 28);
